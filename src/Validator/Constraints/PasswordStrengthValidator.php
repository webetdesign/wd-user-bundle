...
//            $translator->addResource('xlf', dirname(dirname(__DIR__)) . '/Resources/translations/password_strength.fr.xlf', 'fr', 'validators');
    ...
    public function translateTips($tip): string
    {
        return $this->translator->trans(/* @Ignore */ 'strength_password.tip.' . $tip, [], 'validators');
    }

    private function calculateStrength($password, $minStrength): int
    {
        $passwordStrength = 0;
    ...
    private function calculateStrengthUnicode($password, $minStrength): int
    {
        $passwordStrength = 0;
