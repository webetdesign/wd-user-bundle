...
namespace WebEtDesign\UserBundle\Form\Type;
...
use WebEtDesign\UserBundle\Transformer\RestoreRolesTransformer;
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'choice_attr' => function ($choice) {
                return [
                    'data-children' => implode(',', $this->rolesBuilder->getChildrenRoles($choice)),
                ];
            },
