...
class FrontLoginAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    public function getUser($credentials, UserProviderInterface $userProvider): WDUser
    {
