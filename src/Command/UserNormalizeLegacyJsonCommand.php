...
#[AsCommand(
    name: 'user:normalize-legacy-json',
    description: 'Convert legacy PHP-serialized arrays in User JSON columns without hydrating Doctrine entities.',
)]
final class UserNormalizeLegacyJsonCommand extends Command
{
    /** @var array<string, array{table: string, column: string}> */
    private const JSON_COLUMNS = [
        'User permissions' => ['table' => 'user__user', 'column' => 'permissions'],
        'Group permissions' => ['table' => 'user__group', 'column' => 'permissions'],
    ];
